<template>
    <div class="container mx-auto p-4 md:p-8">
        <div class="text-center mb-8 md:mb-12">
            ...
            >
                La directive `v-on` est utilisée pour écouter les événements
                utilisateur et y répondre de manière réactive.
            </p>
        </div>
        ...
        <div class="card bg-base-100 shadow-xl mb-6">
            <div class="card-body">
                <h2 class="card-title text-2xl font-bold mb-4">
                    Qu'est-ce que <code class="text-secondary">v-on</code> ?
                </h2>
                <p>
                    La directive `v-on` vous permet d'attacher des gestionnaires
                    d'événements à des éléments du DOM. Elle est utilisée avec
                    la syntaxe
                    <code class="text-warning">v-on:event="handler"</code> ou
                    sous sa forme abrégée
                    <code class="text-warning">@event="handler"</code>.
                </p>
                <p>
                    Les événements couramment utilisés incluent : `click`,
                    `submit`, `keydown`, et bien d'autres.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="card bg-base-100 shadow-xl rounded-box">
                <div class="card-body">
                    ...
                    <p class="mb-4">
                        Un événement `click` est utilisé pour incrémenter un
                        compteur :
                    </p>
                    ...
                    <div class="card-actions justify-center mt-4">
                        <button @click="increment" class="btn btn-primary mb-3">
                            Cliquez-moi
                        </button>
            ...
            <div class="card bg-base-100 shadow-xl rounded-box">
                <div class="card-body">
                    <h2 class="card-title text-2xl font-bold">
                        Exemple Dynamique avec Paramètres
                    </h2>
                    <p class="mb-4">
        ...
        <div class="card bg-base-100 shadow-xl rounded-box mt-6">
            <div class="card-body">
                <h2 class="card-title text-2xl font-bold">
                    Exemple Avancé : Événements Clavier et Souris
                </h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <!-- Clavier -->
                    <div>
                        <p class="mb-2">Détecter la touche Entrée :</p>
                        <input
                    ...
                    <!-- Input -->
                    <div>
                        <p class="mb-2">Capter la valeur d'un input :</p>
                        <input
                        ...
                        <p class="mt-3 text-lg font-semibold">
                            Chaîne captée :
                            <span class="text-primary">{{ uneString }}</span>
                        </p>
                    </div>
                    <!-- Clic -->
                    <div class="col-span-1 md:col-span-2">
                        <p class="mb-2">Capter l'événement de clic :</p>
                        <button
                            v-on:click="capterClickEvent"
        ...
        <div class="text-center mt-8">
            <p class="text-sm md:text-base text-base-content opacity-50">
                Consultez la
                <a
                    href="https://vuejs.org/guide/essentials/event-handling.html"
