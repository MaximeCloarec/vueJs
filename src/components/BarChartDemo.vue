<template>
    <div class="card bg-base-200 shadow-xl p-6 max-w-xl mx-auto">
        ...
        <button class="btn btn-primary" @click="dynamicData += 50">
            Ajouter +50
        </button>
        <button class="btn btn-secondary" @click="dynamicData = Math.floor(Math.random() * 1500);"> random</button>
    </div>
</template>
